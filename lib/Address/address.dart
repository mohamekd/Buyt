                    ...
                    return !snapshot.hasData
                        ...
                        :ListView.builder(
                          ...
                          itemBuilder: (context,index){
                            ...
                            value: index,
                            addressId: snapshot.data.docs[index].documentID,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("No shipment address has been saved",style: TextStyle(color: Colors.white),),
            Text("Please add your shipment address so that we can deliver product.",style: TextStyle(color: Colors.white),),
          ],
        ),
      ),
    );
...
class AddressCard extends StatefulWidget {
  ...
  AddressCard({Key key,this.model,this.addressId,this.currentIndex,this.totalAmount,this.value}):super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Card(
        ...
        child: Column(
          children: [
            Radio(activeColor:Colors.black,value: widget.value, groupValue: widget.currentIndex, onChanged: (val){
